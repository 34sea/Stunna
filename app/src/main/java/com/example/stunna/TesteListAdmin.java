...
public class TesteListAdmin extends AppCompatActivity {
...
//    }
    ...
    public void carregarListaSocio() {
        bdHelp = new AdminDB(TesteListAdmin.this);
        listaP2 = bdHelp.getListaAdmin();
        bdHelp.close();
        if(listaP2!=null){
            adapter = new ArrayAdapter<Admin>(TesteListAdmin.this, android.R.layout.simple_list_item_1, listaP2);
