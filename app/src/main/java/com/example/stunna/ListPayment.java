...
public class ListPayment extends AppCompatActivity {
...
//        registerForContextMenu(lista);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id){
                ...
                Intent intent = new Intent(ListPayment.this, DadodosUser.class);
                intent.putExtra("perfil", s);
...
//    }
    ...
    public void carregarListaSocio() {
        bdHelp = new SocioDB(ListPayment.this);
        listaP2 = bdHelp.getListaSocio2();
        bdHelp.close();
        if(listaP2!=null){
            adapter = new ArrayAdapter<Socio>(ListPayment.this, android.R.layout.simple_list_item_1, listaP2);
